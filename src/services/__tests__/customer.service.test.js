import {getCustomer,deleteCustomer,updateCustomer,createCustomer} from '../customers.service.js';
...
describe("Customer Service Tests", () => {
    ...
    test("Should Get Correct Data Customers Without Pagination", async () => {
        ...
        fetchMock
            .get(API_ENDPOINT, resultFull)
            .get(`${API_ENDPOINT}1`,resultOne)
    ...
    test("Should Create Customer", async () => {
        fetchMock
            .post(`${API_ENDPOINT}`, listCustomers[0])
